...
namespace DS_Game_Maker
{
    ...
    public partial class Action : Form
    {
        ...
        {
            var resources = new System.ComponentModel.ComponentResourceManager(typeof(Action));
            SubPanel = new Panel();
            ...
            InstancesRadioButton.CheckedChanged += new EventHandler(ThisRadioButton_CheckedChanged);
            InstancesRadioButton.CheckedChanged += new EventHandler(ThisRadioButton_CheckedChanged);
            InstancesOfRadioButton = new RadioButton();
            ThisRadioButton = new RadioButton();
            ThisRadioButton.CheckedChanged += new EventHandler(ThisRadioButton_CheckedChanged);
            ...
            Load += new EventHandler(Action_Load);
            Activated += new EventHandler(Action_Activated);
            ResumeLayout(false);
